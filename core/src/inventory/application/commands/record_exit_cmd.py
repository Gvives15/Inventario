...
from inventory.domain.rules import validate_positive, ensure_non_negative, require_reason
...
def execute(product_id: int, quantity: int, reason: str, user=None, contact=None):
    ...
    with transaction.atomic():
        ...
        create_movement(product, -quantity, MovementTypes.EXIT, reason, new_stock, user, contact)
